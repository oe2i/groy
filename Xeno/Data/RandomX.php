...
class RandomX
{
	...
	// • === alpha » alphabet
	public static function alpha($length = 4, Cases $case = Cases::BOTH)
	{
		return self::create(Cases::value($case), $length);
	}
	...
	{
		return self::alpha($length, Cases::LOWERCASE);
	}
	...
	{
		return self::alpha($length, Cases::UPPERCASE);
	}
