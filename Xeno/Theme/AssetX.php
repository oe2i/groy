<?php //*** AssetX ~ class » Groy™ Library © April, 2025 ∞ OE2i™ • www.oe2i.com ∞ Apache License ***//
...
class AssetX
{
	...
	{
		if (!self::$init) {
			$path = strtolower(EnvX::project('asset'));
			if ($path === 'theme') {
	...
	public static function js($js, $check = true, $baseurl = false)
	{
		...
		return self::file('script/' . $js, $check, $baseurl);
	}
	...
	public static function css($css, $check = true, $baseurl = false)
	{
		...
		return self::file('style/' . $css, $check, $baseurl);
	}
